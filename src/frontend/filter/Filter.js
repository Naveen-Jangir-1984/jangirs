...
const Filter = ({ state, dispatch, members, getHindiText, getHindiNumbers, isModalOpen, isCalendarOpen, isConnectionOpen, isGeographicOpen }) => {
  ...
  return (
    <div className={`filter ${isModalOpen ? "slide-out" : ""}`}>
      ...
      <div className="filter-men">
        <select name="village" value={male.village} disabled={isCalendarOpen || isConnectionOpen || isGeographicOpen} style={{ border: isCalendarOpen || isConnectionOpen || isGeographicOpen ? "1px solid lightgrey" : "1px solid transparent" }} onChange={(e) => dispatch({ type: "male-selection", village: e.target.value, gotra: "" })}>
        ...
        <select name="gotra" value={male.gotra} disabled={isCalendarOpen || isConnectionOpen || isGeographicOpen} style={{ border: isCalendarOpen || isConnectionOpen || isGeographicOpen ? "1px solid lightgrey" : "1px solid transparent" }} onChange={(e) => dispatch({ type: "male-selection", village: "", gotra: e.target.value })}>
      ...
      <div className="filter-women">
        <select name="village" value={female.village} disabled={isCalendarOpen || isConnectionOpen || isGeographicOpen} style={{ border: isCalendarOpen || isConnectionOpen || isGeographicOpen ? "1px solid lightgrey" : "1px solid transparent" }} onChange={(e) => dispatch({ type: "female-selection", village: e.target.value, gotra: "" })}>
        ...
        <select name="gotra" value={female.gotra} disabled={isCalendarOpen || isConnectionOpen || isGeographicOpen} style={{ border: isCalendarOpen || isConnectionOpen || isGeographicOpen ? "1px solid lightgrey" : "1px solid transparent" }} onChange={(e) => dispatch({ type: "female-selection", village: "", gotra: e.target.value })}>
